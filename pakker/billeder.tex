...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=1\linewidth]{billeder/Madonna.jpg}}
\caption{Madonna med ramme}
\label{fig:madonna_ramme}
\end{figure}

\noindent
Hvis du vil have mere avancerede rammer, vil jeg foreslå at du søger på nettet. Der findes en pakke som hedder mdframed som er sej, men det er for meget at skrive om her. \todo{måske hvis caption i fbox?}

\subsubsection{Position}
Hvis du vil styre 

\todo{Skriv om hvordan med billeder.} \todo{text wrap, position...}